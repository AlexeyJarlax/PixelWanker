...
object FirstLaunchDialogPrefs {
    ...
    const val DIALOG_TEXT = "После первого запуска система спросит о выдаче разрешения " +
        "Поверх других приложений. Найдите в списке PixelWanker и выставите тумблер в активный режим"
